              ...
              <div className="flex-1 p-6 md:p-8 overflow-y-auto">
                <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-8 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Inquiry ID: <span className="font-mono text-foreground tracking-[-0.32px]">#CH-8832-NVY</span> ΓÇó Priority: <span className="text-[#b53333] font-medium bg-[#b53333]/10 px-2 py-0.5 rounded">High</span></p>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="md:col-span-1 bg-card border border-border rounded-2xl p-6 md:p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] flex flex-col hover:shadow-[0_4px_20px_rgb(0,0,0,0.06)] transition-shadow">
                ...
                <ul className="space-y-2.5 text-sm text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2"><span className="text-primary mt-0.5">ΓÇó</span> Clean-room segregation</li>
                </ul>
              </div>
              ...
              <div className="md:col-span-1 bg-card border border-border rounded-2xl p-6 md:p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] flex flex-col hover:shadow-[0_4px_20px_rgb(0,0,0,0.06)] transition-shadow">
                ...
                <ul className="space-y-2.5 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-primary mt-0.5">ΓÇó</span> Flanged marine mounting legs</li>
                  <li className="flex items-start gap-2"><span className="text-primary mt-0.5">ΓÇó</span> 316-grade stainless steel</li>
                  <li className="flex items-start gap-2"><span className="text-primary mt-0.5">ΓÇó</span> Anti-spill stormy rails</li>
                </ul>
              </div>
