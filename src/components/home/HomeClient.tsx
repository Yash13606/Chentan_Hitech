...
const BUNDLE_ITEMS = [
  { name: "Commercial Convection Oven", specs: "220V, Stainless Steel", qty: 2, price: "₹4,50,000" },
  { name: "Walk-in Cooler Unit", specs: "8x10ft, Custom Shelving", qty: 1, price: "Configuring..." },
  { name: "Industrial Dishwasher", specs: "Under-counter, High Temp", qty: 3, price: "₹2,10,000" },
];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <Link href="/catalog?industry=DEFENCE" className="md:col-span-1 bg-card border border-border rounded-2xl p-6 md:p-8 flex flex-col hover:border-primary/40 transition-colors group">
                ...
                <ul className="space-y-2.5 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-primary mt-0.5">•</span> 316-grade stainless steel throughout</li>
                  <li className="flex items-start gap-2"><span className="text-primary mt-0.5">•</span> Anti-spill marine mounting</li>
                </ul>
              </Link>
