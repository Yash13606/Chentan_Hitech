...
export function Hero() {
  return (
    <AuroraBackground className="h-auto min-h-[85vh] py-16 md:py-24" showRadialGradient={true}>
      <section className="px-6 max-w-6xl mx-auto flex flex-col justify-center w-full">
        <motion.div
          {...fadeUp(0)}
